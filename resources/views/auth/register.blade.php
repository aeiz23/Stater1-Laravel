...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign up as Driver only</p>
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="row mb-3">
            <label for="role" class="col-md-12 col-form-label text-md-start">Role:</label>
        ...
        <div class="row mb-3">
            <label for="phone" class="col-md-12 col-form-label text-md-start">{{ __('Phone') }}</label>
            <div class="col-md-12">

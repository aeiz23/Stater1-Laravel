...
@section('content')
<div class="container">
    <h1 class="text-center mt-5">Edit Bus</h1>
                              ...
                              <td class="content-cell">
                                  <form action="{{ route('bus.update', $bus->id) }}" method="POST">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                          <input id="phone" name="phone" type="text" class="form-control" value="{{ $bus->user->phone }}" readonly>
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <label for="plate_no" class="col-4 col-form-label">Plate No.</label> 
                                        <div class="col-8">
                                          <input id="plate_no" name="plate_no" type="text" class="form-control" value="{{ $bus->plate_no }}" required="required">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <label for="route" class="col-4 col-form-label">Bus Route</label> 
                                        <div class="col-8">
                                          <input id="route" name="route" type="text" class="form-control" value="{{ $bus->route }}" required="required">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <label for="schedule" class="col-4 col-form-label">Schedule</label> 
                                        <div class="col-8">
                                          <input id="schedule" name="schedule" type="time" class="form-control" value="{{ $bus->schedule }}" required="required">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <label for="link" class="col-4 col-form-label">Link</label> 
                                        <div class="col-8">
                                          <input id="link" name="link" type="text" class="form-control" value="{{ $bus->link }}" required="required">
                                        </div>
                                      </div>
                                      <div class="form-group row">
                                        <label for="status" class="col-4 col-form-label">Status</label> 
                                        <div class="col-8">
                                          <input id="status" name="status" type="text" class="form-control" value="{{ $bus->status }}" readonly>
                                        </div>
                                      </div>
                                      <div class="form-group row">
